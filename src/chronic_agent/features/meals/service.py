...
from chronic_agent.agent.parser import detect_meal_risks, estimate_meal_metrics
from chronic_agent.core.contracts import MealAnalyzeRequest, MealSummaryOut
from chronic_agent.platform.repositories import MealRepository
...
class MealService:
    ...
    def _summary(self, days: int, window: str) -> MealSummaryOut:
